...
cmake -S ../src -B ../build/windows/win32-md-static -G "Visual Studio 16 2019" -A win32 ^
    -DCMAKE_MSVC_RUNTIME_LIBRARY="MultiThreaded$<$<CONFIG:Debug>:Debug>DLL" -DBUILD_SHARED_LIBS=OFF
...
cmake -S ../src -B ../build/windows/win32-mt-static -G "Visual Studio 16 2019" -A win32 ^
    -DCMAKE_MSVC_RUNTIME_LIBRARY="MultiThreaded$<$<CONFIG:Debug>:Debug>" -DBUILD_SHARED_LIBS=OFF
